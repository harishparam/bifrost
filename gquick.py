...
if __name__ == '__main__':
    ...
    print('Listing Emails from mktodemoaccount106@marketo.com..')

    #equery = 'from:hparameswaran.demo@marketo.com after:2016/06/21'
    equery = 'from:hparameswaran.demo@marketo.com is:unread'
    #equery = 'from:mktodemoaccount106@marketo.com is:unread subject:(Learning Time Management Tips from our busiest students) to:(mktodemosvcs+294)'
    ...
    for link in tlinks:
        ...
        resp, content = h.request(link, "GET", headers={'User-Agent':ipad} )
        #print(resp['status'])
        print(opencount)
        opencount+=1
        if opencount > 100 :
